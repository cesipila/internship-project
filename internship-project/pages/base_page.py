...
# many pages inherit from this one and can access below methods
...
class Page:
    ...
    def wait_until_dissapears(self, *locator):
    ...
    def save_screenshot(self, name_of_screenshot):
        self.driver.save_screenshot(f'{name_of_screenshot}.png')
